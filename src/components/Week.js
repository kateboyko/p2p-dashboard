        ...
        return (
            <div id={data.id} key={data.id}>
                ...
                <div><strong>Материалы:&nbsp;</strong>
                    ...
                    <a target="_blank" rel="noopener noreferrer" href={MATERIALS_URL + 'questions0' + data.info.number}> вопросы на
                        встречу</a>,
                    <a target="_blank" rel="noopener noreferrer" href={MATERIALS_URL + 'shandout0' + data.info.number}> секционные
                        материалы</a> +
                    <a target="_blank" rel="noopener noreferrer" href={MATERIALS_URL + 'shandout-solutions0' + data.info.number}> решения</a>
                </div>
                <br/>
                ...
                <div>
                    <Evaluation reviewers={data.reviewers} reviewed={data.reviewed} week_data={data} users={users} my_id={me.id}/>
                </div>
                }
            </div>
        )
